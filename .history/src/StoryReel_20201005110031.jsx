...
function StoryReel() {
    return (
        <div  className='storyReel'>
           ...
           <Story image='https://cdn.dribbble.com/users/256257/screenshots/6521906/headerimagecolored3dribble.png' profileSrc={"https://avatars1.githubusercontent.com/u/8461930?s=460&v=4"} title={"Steve Jobs"}  />
           <Story image='https://images.unsplash.com/photo-1600964373031-f0b65565f354?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=600&q=60' profileSrc={"https://avatars2.githubusercontent.com/u/24712956?s=460&u=b71527e605ae1b748fc2d4157a842e57e427ad44&v=4"} title={"Elon Musk"} />
