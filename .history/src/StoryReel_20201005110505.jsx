...
function StoryReel() {
    return (
        <div  className='storyReel'>
           ...
           <Story image='https://images.unsplash.com/photo-1600964373031-f0b65565f354?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=600&q=60' profileSrc={""} title={"Elon Musk"} />
